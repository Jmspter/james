...
export default function BlogPostPage() {
    ...
    if (!post) {
        return (
            <main className="min-h-screen bg-bg-main text-text-main flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link href="/blog" className="px-6 py-3 bg-primary text-bg-main font-semibold rounded-xl hover:bg-secondary transition-colors">
                        Back to Blog
                    </Link>
                </div>
            </main>
